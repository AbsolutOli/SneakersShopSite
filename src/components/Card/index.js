...
function Card({ id, parentId, image, title, price, onPlus, onLike, loading = false }) {

    const { isCardAdded, isCardLiked } = React.useContext(AppContext);
    ...
    const onClickLike = () => {
        onLike({ id, parentId, image, title, price });
    }
